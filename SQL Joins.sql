...
Left Join countries ON
          Countries.region_id = regions.region_id    --25 records
...
Left Join locations ON
          locations.country_id = countries.country_id    --28 records
...
Right Join departments ON
           departments.department_id = locations.location_id 
...
Join jobs ON 
	 ...
	 Where max_salary > 8000 And job_title <> 'President' 

--10. 
Create Procedure [Sand] as
